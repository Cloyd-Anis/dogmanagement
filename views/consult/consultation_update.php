        ...
        <form action="includes/handlers/dogConsultHandler.php" method="POST">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="dogCondition" class="form-control" placeholder="Condition (ONLY UPDATE ON TYPOS)" id="first">
              </div>
            </div>
            <!--  col-md-6   -->
          ...
          <div class="row">
            ...
            <label for="date">Consultation Date</label>
                <input type="text" name="consultDate" class="form-control" placeholder="dd/mm/yyyy (ONLY UPDATE ON TYPOS)" id="date">
            </div>
          ...
          <button type="submit" name="updateExisting" class="btn btn-primary">Update</button>
        </form>
      </div>
