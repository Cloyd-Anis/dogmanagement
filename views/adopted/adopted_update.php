        ...
        <div class="container mt-3">
            <form>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">    
                        <div class="form-group">            
                            <label for="first">Middle Initial</label>
                            <input type="text" class="form-control" placeholder="" id="first">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">        
                        <div class="form-group">
                            <label for="marking">Address</label>
                            <input type="text" class="form-control" id="marking" placeholder="Address">
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="height">E-mail</label>
                            <input type="text" class="form-control" placeholder="E-mail" id="height">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">        
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="weight" placeholder="Contact Number">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">        
                        <div class="form-group">
                            <label for="length">Dog to be Adopted</label>
                            <input type="text" class="form-control" id="length" placeholder="dogID">
                        </div>
                    </div>                  
