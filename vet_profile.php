...
<body>        
    <div id="content">
        ...
        <div class="card">        
            <img src="./includes/assets/imgs/austinedemay.jpg" alt="John" style="width:100%">
            <h2>ID: 1 | Austine D. Demay</h2>
            <p class="title">09513684213</p>
            <p class="title">austinedemay@gmail.com</p>
            <p>that clinic near our place</p>      
        </div>
